...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupSettingsTab() {
        ...
        // Debug Switch
        val switchDebug: MaterialSwitch = findViewById(R.id.switch_debug_log)
    ...
    private fun showAddRuleDialog() {
        ...
        val switchCase: MaterialSwitch = view.findViewById(R.id.switch_case_sensitive)
                ...
                try {
                    contentResolver.openInputStream(uri)?.use { inputStream ->
                        ...
                        if (settingsManager.importConfigJson(sb.toString())) {
                            ...
                            findViewById<MaterialSwitch>(R.id.switch_debug_log).isChecked = settingsManager.diagnosticLogging
